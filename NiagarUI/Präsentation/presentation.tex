...
\title[NiagarUI] % (optional, nur bei langen Titeln nötig)
{NiagarUI}
...
\section{Motivation für NiagarUI}
...
\begin{frame}{Proof of Concept?}
	\begin{itemize}
		...
		\begin{itemize}
			\item[$\rightarrow$] Später könnte niagarino so von NiagarUI angesteuert werden
