/*
 * @(#)AccidentReportPrint.java   1.0   Jul 17, 2015
 *
...
/**
 * Writer of accident reports. This is the version compliant to the validator.
 *
 * @author Florian 'Sammy' Junghanns &lt;florian.junghanns@uni-konstanz.de&gt;
 * @version 1.0
 */
public class AccidentReportPrint extends Print {

   /** Name of the target file. */
   public static final String TARGET_FILE = "report_accident.csv";

   /** Format to use for writing to results file. */
   private static final String FORMAT = "1,%1$d,%2$d,%3$d,%4$d%n";
    ...
    */
   public AccidentReportPrint(final String operatorId, final Schema inputSchema)
         throws FileNotFoundException {
   ...
   protected void processTuple(final int input, final DataTuple tuple) {
      if (this.out != null) {
         ...
         this.out.printf(FORMAT, time, emit, vid, seg);
      }
