...
public class ParamDescription {
	...
	/**
	 * Static helper method to lookup a type of ParamDescription.
	 * 
	 * @param i
	 *            The ParamDescription as int e.g. ParamDescription.STRING.
	 * @return The name of the ParamDescription type.
	 */
	public static String getTypeName(int i) {
		return TYPES.get(i).getClass().getName();
	}
