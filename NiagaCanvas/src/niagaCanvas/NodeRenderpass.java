 ...
 *            The type of nodes.
 */
public class NodeRenderpass<T extends AnimatedPosition> extends Renderpass {
    ...
    /** The node realizer. */
    private NodeRealizer<T> streamRealizer;
    /** The node realizer. */
    private NodeRealizer<T> operatorRealizer;
     ...
     *            The view on the graph.
     */
    public NodeRenderpass(final LayoutedView<T> view) {
        this.view = Objects.requireNonNull(view);
        this.streamRealizer = new DefaultNodeRealizer<T>();
        this.operatorRealizer = new RectangularNodeRealizer<T>();
        layout = view;
        bbox = null;
    }
     ...
     */
    public NodeRenderpass(final NodeLinkView<T> view, final Rectangle2D bbox) {
        this.view = Objects.requireNonNull(view);
