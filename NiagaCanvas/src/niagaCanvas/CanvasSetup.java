...
public final class CanvasSetup {
	 ...
	 *            The canvas.
	 * @param p
	 *            The render pass painter.
	 * @param fps
	 *            Whether to give the option to show fps.
	 * @param pause
	 *            Whether to give the option to pause animations. This is only
	 *            possible when the render pass painter can animation.
	 * @param reset
	 *            Whether to give the option to reset the view.
	 * @param frameScreenshot
	 *            Whether to take screenshots from the frame or the canvas.
	 * @return The info HUD to enable more actions.
	 */
	public static SimpleTextHUD setupCanvas(final String name, final Canvas c, final RenderpassPainter p,
			final boolean fps, final boolean pause, final boolean reset, final boolean frameScreenshot) {
		final EditorUI frame = new EditorUI(c);
	 ...
	 * @return The info HUD to enable more actions.
	 */
	public static SimpleTextHUD setupCanvas(final EditorUI frame, final Canvas c, final RenderpassPainter p,
			final boolean fps, final boolean pause, final boolean reset, final boolean frameScreenshot) {
	 ...
	 *            Whether to take screenshots from the frame or the canvas.
	 * @param layout
	 *            Whether to add the canvas and lay out the component and frame
	 *            afterwards.
	 * @return The info HUD to enable more actions.
	 */
	public static SimpleTextHUD setupCanvas(final EditorUI frame, final Canvas c, final RenderpassPainter p,
		...
		c.addMessageAction(KeyEvent.VK_P, canvasId + "#photo" + (frameScreenshot ? ":window" : ""));
